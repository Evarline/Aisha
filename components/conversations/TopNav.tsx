  ...
  return (
    <div className="py-2 bg-[#FFFFFF] border-b border-gray-200/60 shadow-sm flex items-center justify-between px-4 md:px-10 shrink-0 select-none">
      ...
      <div className="flex justify-center flex-1 px-4 md:px-8">
         <div className="flex bg-white ring-1 ring-gray-200 shadow-inner rounded-full items-center px-4 py-2 w-full max-w-xl transition-all hover:shadow-md focus-within:shadow-md focus-within:ring-gray-300">
            <input type="text" placeholder="Search" className="text-[14px] text-black/70 flex-1 font-['Inter'] font-normal bg-transparent outline-none" />
            <img src="/Icons/MagnifyingGlass.svg" alt="Search" className="w-[20px] h-[20px]"
      ...
      <div className="flex items-center gap-4 md:gap-6 justify-end">
        <button className="hidden md:flex lg:hidden text-[13px] font-medium text-[#001407] hover:text-[#001407]/70 transition-colors px-3 py-1.5 rounded-lg border border-gray-200 hover:bg-gray-50">
          View Analytics
        </button>
        <div className="relative cursor-pointer w-[40px] h-[40px] flex items-center justify-center shrink-0">
          <img src="/Icons/Bell.svg" alt="Notifications" className="w-[24px] h-[24px] object-contain"
               style={{ filter: 'brightness(0)' }}
               onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          <div className="absolute top-[8px] right-[8px] w-[8px] h-[8px] bg-[#FF4D4D] rounded-full border-[1.5px] border-white z-10"></div>
        </div>
