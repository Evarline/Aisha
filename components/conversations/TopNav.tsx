...
export function TopNav({ title = "Conversations", onBackClick }: TopNavProps) {
  return (
    <div className="py-2 sticky top-0 z-40 bg-white/70 backdrop-blur-lg border-b border-gray-200/50 shadow-sm flex items-center justify-between px-4 sm:px-6 lg:px-8 shrink-0 select-none transition-all">
      ...
      <div className="hidden md:flex justify-center flex-1 px-4 lg:px-8 min-w-0">
         <div className="flex bg-white ring-1 ring-gray-200 shadow-inner rounded-full items-center px-4 py-2 w-full max-w-xl transition-all hover:shadow-md focus-within:shadow-md focus-within:ring-gray-300 min-w-0">
            <input type="text" placeholder="Search chats..." className="text-[14px] text-black/70 flex-1 font-['Inter'] font-normal bg-transparent outline-none w-full min-w-0" />
